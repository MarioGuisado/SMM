...
public class curva extends QuadCurve2D.Double implements figuras{
    ...
    /**
     * Define la posición de la curva en el lienzo. Calcula la diferencia de posición entre el punto inicial de dibujado y aquel pasado por parámetro.
     * Crea un nuevo punto a partir de esta información y define la curva en el nuevo punto resultante.
     * @param pos objeto Point2D a partir del cual trasladamos la figura.
     */
     public void setLocation(Point2D pos) {
        double dx = pos.getX() - this.getX1();
        double dy = pos.getY() - this.getY1();
        Point2D newp2 = new Point2D.Double(this.getX2() + dx, this.getY2() + dy);
        Point2D ctrlpoint = new Point2D.Double(this.getCtrlX() + dx, this.getCtrlY() + dy);
        this. setCurve(pos, ctrlpoint, newp2);
    }
     /**
